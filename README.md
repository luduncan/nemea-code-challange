...
![](https://travis-ci.org/cucumber/cucumber-java-challange.svg)
...
Git:
    ...
    git clone https://github.com/cucumber/cucumber-java-challange.git
    cd cucumber-java-challange

Subversion:

    svn checkout https://github.com/cucumber/cucumber-java-challange/trunk cucumber-java-challange
    cd cucumber-java-challange

Or simply [download a zip](https://github.com/cucumber/cucumber-java-challange/archive/master.zip) file.
...
Specify a particular scenario by *line* (and use the pretty plugin, which prints the scenario back)
    ...
    -Dcucumber.options="classpath:challange/belly.feature:4 --plugin pretty"

This works because Maven puts `./src/test/resources` on your `classpath`.
You can also specify files to run by filesystem path:

    -Dcucumber.options="src/test/resources/challange/belly.feature:4 --plugin pretty"
